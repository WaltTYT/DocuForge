  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 animate-bounce-in overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-accent-50 rounded-full translate-y-1/2 -translate-x-1/2 pointer-events-none" />
        ...
        <button
          ...
          className="absolute top-4 right-4 z-10 p-2.5 hover:bg-slate-100 rounded-xl transition-all duration-200 hover:scale-110"
        >
